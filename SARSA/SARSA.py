...
def sarsa(episodes=1000, training=True, render=True):
    def choose_action():
            ...
            if training:
                q[state_pos, state_vl, state_ang, state_angvl, action] = q[
                                                                             state_pos, state_vl, state_ang, state_angvl, action] + alpha * (
                                                                                 reward + gamma * q[
                                                                             new_state_pos, new_state_vl,
                                                                             new_state_ang, new_state_angvl, new_action] -
                                                                                 q[
...
avg = sarsa(100000, training=True, render=False)

# plt.plot(avg, label='SARSA')
